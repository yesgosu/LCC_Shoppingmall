		...
		<div class="row">
			<div class="col-md-8">
				<div class="row" style="margin: 20px;" align="center">
					<img src="./woman/WSuit/포플린 미니 점프수트_WC17/WC17_2.png" width="100%">
					<h5></h5>
					<img src="./woman/WSuit/포플린 미니 점프수트_WC17/WC17_3.png" width="100%">
					<h5></h5>
					<img src="./woman/WSuit/포플린 미니 점프수트_WC17/WC17_4.png" width="100%">
					<h5></h5>
			...
			<div class="col-md-4" align="center">
				<div style="position: fixed; left: 68%; transform: translate(-32%, 0);">
					<div style="margin-top: 20px"><h4>포플린 미니 점프수트</h4></div>
					...
					<p>INFO</p>
					PLAYSUIT WITH A ROUND NECKLINE AND THIN STRAPS. 
					FEATURING SIDE IN-SEAM POCKETS AND A TIED OPENING AT THE FRONT.
					</div>
