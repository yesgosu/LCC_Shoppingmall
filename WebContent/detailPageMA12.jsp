		...
		<div class="row">
			<div class="col-md-8">
				<div class="row" style="margin: 20px;" align="center">
					<img src="./man/Jacket/코튼 코치 점퍼_MA12/MA12_2.png" width="100%">
					<h5></h5>
					<img src="./man/Jacket/코튼 코치 점퍼_MA12/MA12_3.png" width="100%">
					<h5></h5>
					<img src="./man/Jacket/코튼 코치 점퍼_MA12/MA12_4.png" width="100%">
					<h5></h5>
					<img src="./man/Jacket/코튼 코치 점퍼_MA12/MA12_5.png" width="100%">
					<h5></h5>
					<img src="./man/Jacket/코튼 코치 점퍼_MA12/MA12_6.png" width="100%">
					<h5></h5>
					<img src="./man/Jacket/코튼 코치 점퍼_MA12/MA12_7.png" width="100%">
					<h5></h5>
			...
			<div class="col-md-4" align="center">
				<div style="position: fixed; left: 68%; transform: translate(-32%, 0);">
					<div style="margin-top: 20px"><h4>코튼 코치 점퍼</h4></div>
