		...
		<div class="row">
			<div class="col-md-8">
				<div class="row" style="margin: 20px;" align="center">
					<img src="./woman/WPants/패턴 슬림핏 팬츠_WF16/WF16_2.png" width="100%">
					<h5></h5>
					<img src="./woman/WPants/패턴 슬림핏 팬츠_WF16/WF16_3.png" width="100%">
					<h5></h5>
					<img src="./woman/WPants/패턴 슬림핏 팬츠_WF16/WF16_4.png" width="100%">
					<h5></h5>
					<img src="./woman/WPants/패턴 슬림핏 팬츠_WF16/WF16_5.png" width="100%">
					<h5></h5>
					<img src="./woman/WPants/패턴 슬림핏 팬츠_WF16/WF16_6.png" width="100%">
					<h5></h5>
					<img src="./woman/WPants/패턴 슬림핏 팬츠_WF16/WF16_7.png" width="100%">
					<h5></h5>
			...
			<div class="col-md-4" align="center">
				<div style="position: fixed; left: 68%; transform: translate(-32%, 0);">
					<div style="margin-top: 20px"><h4>패턴 슬림핏 팬츠</h4></div>
					...
					<p>INFO</p>
					앞면에 포켓이 있는 하이웨이스트 팬츠. 
					옆면 트임이 있는 밑단. 
					앞면에서 지퍼, 버튼 및 메탈 후크로 여밈.
					</div>
