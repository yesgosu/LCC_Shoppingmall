		...
		<div class="row">
			<div class="col-md-8">
				<div class="row" style="margin: 20px;" align="center">
					<img src="./woman/WBlazer/타이트핏 블레이저_WB16/WB16_2.png" width="100%">
					<h5></h5>
					<img src="./woman/WBlazer/타이트핏 블레이저_WB16/WB16_3.png" width="100%">
					<h5></h5>
					<img src="./woman/WBlazer/타이트핏 블레이저_WB16/WB16_4.png" width="100%">
					<h5></h5>
					<img src="./woman/WBlazer/타이트핏 블레이저_WB16/WB16_5.png" width="100%">
					<h5></h5>
					<img src="./woman/WBlazer/타이트핏 블레이저_WB16/WB16_6.png" width="100%">
					<h5></h5>
			...
			<div class="col-md-4" align="center">
				<div style="position: fixed; left: 68%; transform: translate(-32%, 0);">
					<div style="margin-top: 20px"><h4>타이트핏 블레이저</h4></div>
					...
					<p>INFO</p>
					어깨가 강조된 디자인의 라펠 칼라 긴소매 타이트핏 블레이저. 
					앞면 플랩 포켓. 
					앞면 메탈 버튼 크로스 여밈.
					</div>
