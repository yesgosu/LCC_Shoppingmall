		...
		<div class="row">
			<div class="col-md-8">
				<div class="row" style="margin: 20px;" align="center">
					<img src="./man/Jacket/코듀로이 콤비 워커 점퍼_MA10/MA10_2.png" width="100%">
					<h5></h5>
					<img src="./man/Jacket/코듀로이 콤비 워커 점퍼_MA10/MA10_3.png" width="100%">
					<h5></h5>
					<img src="./man/Jacket/코듀로이 콤비 워커 점퍼_MA10/MA10_4.png" width="100%">
					<h5></h5>
					<img src="./man/Jacket/코듀로이 콤비 워커 점퍼_MA10/MA10_5.png" width="100%">
					<h5></h5>
					<img src="./man/Jacket/코듀로이 콤비 워커 점퍼_MA10/MA10_6.png" width="100%">
					<h5></h5>
					<img src="./man/Jacket/코듀로이 콤비 워커 점퍼_MA10/MA10_7.png" width="100%">
					<h5></h5>
				</div>
			</div>
			...
			<div class="col-md-4" align="center">
				...
				<div style="position: fixed; left: 68%; transform: translate(-32%, 0);">
					<div style="margin-top: 20px"><h4>코듀로이 콤비 워커 점퍼</h4></div>
					...
					배색된 소재가 매치된 라펠 칼라 점퍼.
					 버튼이 달린 커프스 마감 긴소매 디자인.
					 가슴 부분과 골반 양 옆면 패치 포켓.
					  배색된 스티치 디테일. 앞면 버튼 여밈.
					</div>
