		...
		<div class="row">
			<div class="col-md-8">
				<div class="row" style="margin: 20px;" align="center">
					<img src="./woman/WSuit/린넨 프린트 원피스_WC03/WC03_2.png" width="100%">
					<h5></h5>
					<img src="./woman/WSuit/린넨 프린트 원피스_WC03/WC03_3.png" width="100%">
					<h5></h5>
					<img src="./woman/WSuit/린넨 프린트 원피스_WC03/WC03_4.png" width="100%">
					<h5></h5>
			...
			<div class="col-md-4" align="center">
				<div style="position: fixed; left: 68%; transform: translate(-32%, 0);">
					<div style="margin-top: 20px"><h4>린넨 프린트 원피스</h4></div>
					...
					<p>INFO</p>
					DRESS MADE OF A LINEN BLEND. 
                    NECKLINE AND THIN STRAPS.
					</div>
