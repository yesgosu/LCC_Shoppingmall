		...
		<div class="row">
			<div class="col-md-8">
				<div class="row" style="margin: 20px;" align="center">
					<img src="./woman/WSuit/펀칭 자수 미디 원피스_WC15/WC15_2.png" width="100%">
					<h5></h5>
					<img src="./woman/WSuit/펀칭 자수 미디 원피스_WC15/WC15_3.png" width="100%">
					<h5></h5>
					<img src="./woman/WSuit/펀칭 자수 미디 원피스_WC15/WC15_4.png" width="100%">
					<h5></h5>
					<img src="./woman/WSuit/펀칭 자수 미디 원피스_WC15/WC15_5.png" width="100%">
					<h5></h5>
			...
			<div class="col-md-4" align="center">
				<div style="position: fixed; left: 68%; transform: translate(-32%, 0);">
					<div style="margin-top: 20px"><h4>펀칭 자수 미디 원피스</h4></div>
					...
					<p>INFO</p>
					DRESS FEATURING A SLOT COLLAR, 
					LONG SLEEVES WITH ELASTIC TRIM, 
					CUTWORK EMBROIDERY DETAIL, 
					MATCHING LINING AND A BUTTON-UP FRONT.
					</div>
