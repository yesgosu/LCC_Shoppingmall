		...
		<div class="row">
			<div class="col-md-8">
				<div class="row" style="margin: 20px;" align="center">
					<img src="./man/Blazer/더블 브레스트 블레이저_MB01/MB01_2.png" width="100%">
					<h5></h5>
					<img src="./man/Blazer/더블 브레스트 블레이저_MB01/MB01_3.png" width="100%">
					<h5></h5>
					<img src="./man/Blazer/더블 브레스트 블레이저_MB01/MB01_4.png" width="100%">
					<h5></h5>
					<img src="./man/Blazer/더블 브레스트 블레이저_MB01/MB01_5.png" width="100%">
					<h5></h5>
					<img src="./man/Blazer/더블 브레스트 블레이저_MB01/MB01_6.png" width="100%">
					<h5></h5>
					<img src="./man/Blazer/더블 브레스트 블레이저_MB01/MB01_7.png" width="100%">
					<h5></h5>
			...
			<div class="col-md-4" align="center">
				<div style="position: fixed; left: 68%; transform: translate(-32%, 0);">
					<div style="margin-top: 20px"><h4>더블 브레스트 블레이저</h4></div>
