		...
		<div class="row">
			<div class="col-md-8">
				<div class="row" style="margin: 20px;" align="center">
					<img src="./woman/WShit/타이다이 프린트 셔츠_WD14/WD14_2.png" width="100%">
					<h5></h5>
					<img src="./woman/WShit/타이다이 프린트 셔츠_WD14/WD14_3.png" width="100%">
					<h5></h5>
					<img src="./woman/WShit/타이다이 프린트 셔츠_WD14/WD14_4.png" width="100%">
					<h5></h5>
					<img src="./woman/WShit/타이다이 프린트 셔츠_WD14/WD14_5.png" width="100%">
					<h5></h5>
					<img src="./woman/WShit/타이다이 프린트 셔츠_WD14/WD14_6.png" width="100%">
					<h5></h5>
					<img src="./woman/WShit/타이다이 프린트 셔츠_WD14/WD14_7.png" width="100%">
					<h5></h5>
			...
			<div class="col-md-4" align="center">
				<div style="position: fixed; left: 68%; transform: translate(-32%, 0);">
					<div style="margin-top: 20px"><h4>타이다이 프린트 셔츠</h4></div>
