		...
		<div class="row">
			<div class="col-md-8">
				<div class="row" style="margin: 20px;" align="center">
					<img src="./woman/WShirt/포플린 콤비 셔츠_WD18/WD18_2.png" width="100%">
					<h5></h5>
					<img src="./woman/WShirt/포플린 콤비 셔츠_WD18/WD18_3.png" width="100%">
					<h5></h5>
					<img src="./woman/WShirt/포플린 콤비 셔츠_WD18/WD18_4.png" width="100%">
					<h5></h5>
			...
			<div class="col-md-4" align="center">
				<div style="position: fixed; left: 68%; transform: translate(-32%, 0);">
					<div style="margin-top: 20px"><h4>포플린 콤비 셔츠</h4></div>
					...
					<p>INFO</p>
					벌룬 스타일 7부 소매 피터팬 칼라 셔츠. 
					바디 부분에 허니콤 스타일 소재가 매치됨. 
					앞면 버튼 여밈.
					</div>
