		...
		<div class="row">
			<div class="col-md-8">
				<div class="row" style="margin: 20px;" align="center">
					<img src="./man/Blazer/컴포트 수트 블레이저_MB12/MB012_2.png" width="100%">
					<h5></h5>
					<img src="./man/Blazer/컴포트 수트 블레이저_MB12/MB012_3.png" width="100%">
					<h5></h5>
					<img src="./man/Blazer/컴포트 수트 블레이저_MB12/MB012_4.png" width="100%">
					<h5></h5>
					<img src="./man/Blazer/컴포트 수트 블레이저_MB12/MB012_5.png" width="100%">
					<h5></h5>
					<img src="./man/Blazer/컴포트 수트 블레이저_MB12/MB012_6.png" width="100%">
					<h5></h5>
					<img src="./man/Blazer/컴포트 수트 블레이저_MB12/MB012_7.png" width="100%">
					<h5></h5>
			...
			<div class="col-md-4" align="center">
				<div style="position: fixed; left: 68%; transform: translate(-32%, 0);">
					...
					피크 라펠 칼라. 버튼 디테일 커프스 마감 긴소매 디자인. 
