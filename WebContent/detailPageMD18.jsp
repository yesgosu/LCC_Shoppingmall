		...
		<div class="row">
			<div class="col-md-8">
				<div class="row" style="margin: 20px;" align="center">
					<img src="./man/Shirt/패턴 데님 셔츠_MD18/MD18_2.png" width="100%">
					<h5></h5>
					<img src="./man/Shirt/패턴 데님 셔츠_MD18/MD18_3.png" width="100%">
					<h5></h5>
					<img src="./man/Shirt/패턴 데님 셔츠_MD18/MD18_4.png" width="100%">
					<h5></h5>
					<img src="./man/Shirt/패턴 데님 셔츠_MD18/MD18_5.png" width="100%">
					<h5></h5>
					<img src="./man/Shirt/패턴 데님 셔츠_MD18/MD18_6.png" width="100%">
					<h5></h5>
					<img src="./man/Shirt/패턴 데님 셔츠_MD18/MD18_7.png" width="100%">
					<h5></h5>
			...
			<div class="col-md-4" align="center">
				<div style="position: fixed; left: 68%; transform: translate(-32%, 0);">
					<div style="margin-top: 20px"><h4>패턴 데님 셔츠</h4></div>
