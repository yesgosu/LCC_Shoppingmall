		...
		<div class="row">
			<div class="col-md-8">
				<div class="row" style="margin: 20px;" align="center">
					<img src="./man/Pants/하이테크 카고 팬츠 카키_MF18/MF18_2.png" width="100%">
					<h5></h5>
					<img src="./man/Pants/하이테크 카고 팬츠 카키_MF18/MF18_3.png" width="100%">
					<h5></h5>
					<img src="./man/Pants/하이테크 카고 팬츠 카키_MF18/MF18_4.png" width="100%">
					<h5></h5>
					<img src="./man/Pants/하이테크 카고 팬츠 카키_MF18/MF18_5.png" width="100%">
					<h5></h5>
					<img src="./man/Pants/하이테크 카고 팬츠 카키_MF18/MF18_6.png" width="100%">
					<h5></h5>
					<img src="./man/Pants/하이테크 카고 팬츠 카키_MF18/MF18_7.png" width="100%">
					<h5></h5>
			...
			<div class="col-md-4" align="center">
				<div style="position: fixed; left: 68%; transform: translate(-32%, 0);">
					<div style="margin-top: 20px"><h4>하이테크 카고 팬츠 카키</h4></div>
