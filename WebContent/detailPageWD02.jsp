		...
		<div class="row">
			<div class="col-md-8">
				<div class="row" style="margin: 20px;" align="center">
					<img src="./woman/WShit/러스틱 크롭 셔츠_WD02/WD02_2.png" width="100%">
					<h5></h5>
					<img src="./woman/WShit/러스틱 크롭 셔츠_WD02/WD02_3.png" width="100%">
					<h5></h5>
					<img src="./woman/WShit/러스틱 크롭 셔츠_WD02/WD02_4.png" width="100%">
					<h5></h5>
					<img src="./woman/WShit/러스틱 크롭 셔츠_WD02/WD02_5.png" width="100%">
					<h5></h5>
					<img src="./woman/WShit/러스틱 크롭 셔츠_WD02/WD02_6.png" width="100%">
					<h5></h5>
					<img src="./woman/WShit/러스틱 크롭 셔츠_WD02/WD02_7.png" width="100%">
					<h5></h5>
			...
			<div class="col-md-4" align="center">
				<div style="position: fixed; left: 68%; transform: translate(-32%, 0);">
					<div style="margin-top: 20px"><h4>러스틱 크롭 셔츠</h4></div>
					...
					FEATURING FRONT PATCH POCKETS WITH FLAPS AND A METAL BUTTON-UP FRONT.
					</div>
