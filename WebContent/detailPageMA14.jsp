		...
		<div class="row">
			<div class="col-md-8">
				<div class="row" style="margin: 20px;" align="center">
					<img src="./man/Jacket/패딩 점퍼_MA14/MA14_2.png" width="100%">
					<h5></h5>
					<img src="./man/Jacket/패딩 점퍼_MA14/MA14_3.png" width="100%">
					<h5></h5>
					<img src="./man/Jacket/패딩 점퍼_MA14/MA14_4.png" width="100%">
					<h5></h5>
					<img src="./man/Jacket/패딩 점퍼_MA14/MA14_5.png" width="100%">
					<h5></h5>
					<img src="./man/Jacket/패딩 점퍼_MA14/MA14_6.png" width="100%">
					<h5></h5>
					<img src="./man/Jacket/패딩 점퍼_MA14/MA14_7.png" width="100%">
					<h5></h5>
			...
			<div class="col-md-4" align="center">
				<div style="position: fixed; left: 68%; transform: translate(-32%, 0);">
					...
					<p>INFO</p>
					내부가 얇게 퀼팅 처리된 점퍼. 신축성 있는 커프스 마감 긴소매 라펠 칼라 디자인. 
