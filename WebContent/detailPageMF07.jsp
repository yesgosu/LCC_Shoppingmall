		...
		<div class="row">
			<div class="col-md-8">
				<div class="row" style="margin: 20px;" align="center">
					<img src="./man/Pants/오버사이즈 플리츠 팬츠 블랙_MF07/MF07_2.png" width="100%">
					<h5></h5>
					<img src="./man/Pants/오버사이즈 플리츠 팬츠 블랙_MF07/MF07_3.png" width="100%">
					<h5></h5>
					<img src="./man/Pants/오버사이즈 플리츠 팬츠 블랙_MF07/MF07_4.png" width="100%">
					<h5></h5>
					<img src="./man/Pants/오버사이즈 플리츠 팬츠 블랙_MF07/MF07_5.png" width="100%">
					<h5></h5>
					<img src="./man/Pants/오버사이즈 플리츠 팬츠 블랙_MF07/MF07_6.png" width="100%">
					<h5></h5>
					<img src="./man/Pants/오버사이즈 플리츠 팬츠 블랙_MF07/MF07_7.png" width="100%">
					<h5></h5>
			...
			<div class="col-md-4" align="center">
				<div style="position: fixed; left: 68%; transform: translate(-32%, 0);">
					<div style="margin-top: 20px"><h4>오버사이즈 플리츠 팬츠 블랙</h4></div>
