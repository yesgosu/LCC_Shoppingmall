		...
		<div class="row">
			<div class="col-md-8">
				<div class="row" style="margin: 20px;" align="center">
					<img src="./man/Suit/슬림 수트 팬츠_MC07/MC07_2.png" width="100%">
					<h5></h5>
					<img src="./man/Suit/슬림 수트 팬츠_MC07/MC07_3.png" width="100%">
					<h5></h5>
					<img src="./man/Suit/슬림 수트 팬츠_MC07/MC07_4.png" width="100%">
					<h5></h5>
					<img src="./man/Suit/슬림 수트 팬츠_MC07/MC07_5.png" width="100%">
					<h5></h5>
					<img src="./man/Suit/슬림 수트 팬츠_MC07/MC07_6.png" width="100%">
					<h5></h5>
					<img src="./man/Suit/슬림 수트 팬츠_MC07/MC07_7.png" width="100%">
					<h5></h5>
			...
			<div class="col-md-4" align="center">
				<div style="position: fixed; left: 68%; transform: translate(-32%, 0);">
					<div style="margin-top: 20px"><h4>슬림 수트 팬츠</h4></div>
					...
					<p>INFO</p>
					앞면 포켓과 더블 파이핑 처리된 뒷면 포켓이 매치된 슬림핏 팬츠. 
					앞면 지퍼와 버튼 여밈.
					</div>
