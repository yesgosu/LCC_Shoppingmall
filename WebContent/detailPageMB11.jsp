		...
		<div class="row">
			<div class="col-md-8">
				<div class="row" style="margin: 20px;" align="center">
					<img src="./man/Blazer/컴포트 니트 블레이저_MB11/MB11_2.png" width="100%">
					<h5></h5>
					<img src="./man/Blazer/컴포트 니트 블레이저_MB11/MB11_3.png" width="100%">
					<h5></h5>
					<img src="./man/Blazer/컴포트 니트 블레이저_MB11/MB11_4.png" width="100%">
					<h5></h5>
					<img src="./man/Blazer/컴포트 니트 블레이저_MB11/MB11_5.png" width="100%">
					<h5></h5>
					<img src="./man/Blazer/컴포트 니트 블레이저_MB11/MB11_6.png" width="100%">
					<h5></h5>
					<img src="./man/Blazer/컴포트 니트 블레이저_MB11/MB11_7.png" width="100%">
					<h5></h5>
			...
			<div class="col-md-4" align="center">
				<div style="position: fixed; left: 68%; transform: translate(-32%, 0);">
					<div style="margin-top: 20px"><h4>컴포트 니트 블레이저</h4></div>
