		...
		<div class="row">
			<div class="col-md-8">
				<div class="row" style="margin: 20px;" align="center">
					<img src="./woman/WJacket/콤비 패딩 점퍼_WA12/WA12_2.png" width="100%">
					<h5></h5>
					<img src="./woman/WJacket/콤비 패딩 점퍼_WA12/WA12_3.png" width="100%">
					<h5></h5>
					<img src="./woman/WJacket/콤비 패딩 점퍼_WA12/WA12_4.png" width="100%">
					<h5></h5>
					<img src="./woman/WJacket/콤비 패딩 점퍼_WA12/WA12_5.png" width="100%">
					<h5></h5>
					<img src="./woman/WJacket/콤비 패딩 점퍼_WA12/WA12_6.png" width="100%">
					<h5></h5>
					<img src="./woman/WJacket/콤비 패딩 점퍼_WA12/WA12_7.png" width="100%">
					<h5></h5>
			...
			<div class="col-md-4" align="center">
				<div style="position: fixed; left: 68%; transform: translate(-32%, 0);">
					<div style="margin-top: 20px"><h4>콤비 패딩 점퍼</h4></div>
					...
					<p>INFO</p>
					코듀로이 소재가 매치된 라펠 칼라 긴소매 점퍼. 
					앞면 플랩 포켓. 앞면 메탈 스냅 버튼으로 여밈.
					</div>
