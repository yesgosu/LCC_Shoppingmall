		...
		<div class="row">
			<div class="col-md-8">
				<div class="row" style="margin: 20px;" align="center">
					<img src="./man/Blazer/컴포트 스트럭처 수트 블레이저_MB13/MB13_2.png" width="100%">
					<h5></h5>
					<img src="./man/Blazer/컴포트 스트럭처 수트 블레이저_MB13/MB13_3.png" width="100%">
					<h5></h5>
					<img src="./man/Blazer/컴포트 스트럭처 수트 블레이저_MB13/MB13_4.png" width="100%">
					<h5></h5>
					<img src="./man/Blazer/컴포트 스트럭처 수트 블레이저_MB13/MB13_5.png" width="100%">
					<h5></h5>
					<img src="./man/Blazer/컴포트 스트럭처 수트 블레이저_MB13/MB13_6.png" width="100%">
					<h5></h5>
					<img src="./man/Blazer/컴포트 스트럭처 수트 블레이저_MB13/MB13_7.png" width="100%">
					<h5></h5>
