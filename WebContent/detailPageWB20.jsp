		...
		<div class="row">
			<div class="col-md-8">
				<div class="row" style="margin: 20px;" align="center">
					<img src="./woman/WBlazer/플루이드 블레이저_WB20/WB20_2.png" width="100%">
					<h5></h5>
					<img src="./woman/WBlazer/플루이드 블레이저_WB20/WB20_3.png" width="100%">
					<h5></h5>
					<img src="./woman/WBlazer/플루이드 블레이저_WB20/WB20_4.png" width="100%">
					<h5></h5>
					<img src="./woman/WBlazer/플루이드 블레이저_WB20/WB20_5.png" width="100%">
					<h5></h5>
					<img src="./woman/WBlazer/플루이드 블레이저_WB20/WB20_6.png" width="100%">
					<h5></h5>
					<img src="./woman/WBlazer/플루이드 블레이저_WB20/WB20_7.png" width="100%">
					<h5></h5>
			...
			<div class="col-md-4" align="center">
				<div style="position: fixed; left: 68%; transform: translate(-32%, 0);">
					<div style="margin-top: 20px"><h4>플루이드 블레이저</h4></div>
					...
					<p>INFO</p>
					트임 마감 긴소매 라펠 칼라 블레이저. 
					앞면 플랩 포켓과 가슴 부분 페이크 파이핑 포켓. 
					더블 브레스트 스타일 버튼 여밈.
					</div>
