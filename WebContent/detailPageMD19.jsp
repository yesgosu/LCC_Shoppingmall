		...
		<div class="row">
			<div class="col-md-8">
				<div class="row" style="margin: 20px;" align="center">
					<img src="./man/Shirt/프루츠 패턴 셔츠_MD19/MD19_2.png" width="100%">
					<h5></h5>
					<img src="./man/Shirt/프루츠 패턴 셔츠_MD19/MD19_3.png" width="100%">
					<h5></h5>
					<img src="./man/Shirt/프루츠 패턴 셔츠_MD19/MD19_4.png" width="100%">
					<h5></h5>
					<img src="./man/Shirt/프루츠 패턴 셔츠_MD19/MD19_5.png" width="100%">
					<h5></h5>
					<img src="./man/Shirt/프루츠 패턴 셔츠_MD19/MD19_6.png" width="100%">
					<h5></h5>
					<img src="./man/Shirt/프루츠 패턴 셔츠_MD19/MD19_7.png" width="100%">
					<h5></h5>
			...
			<div class="col-md-4" align="center">
				<div style="position: fixed; left: 68%; transform: translate(-32%, 0);">
					<div style="margin-top: 20px"><h4>프루츠 패턴 셔츠</h4></div>
