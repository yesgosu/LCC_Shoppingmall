		...
		<div class="row">
			<div class="col-md-8">
				<div class="row" style="margin: 20px;" align="center">
					<img src="./woman/WPants/프런트 크로스 매니시 팬츠_WF18/WF18_2.png" width="100%">
					<h5></h5>
					<img src="./woman/WPants/프런트 크로스 매니시 팬츠_WF18/WF18_3.png" width="100%">
					<h5></h5>
					<img src="./woman/WPants/프런트 크로스 매니시 팬츠_WF18/WF18_4.png" width="100%">
					<h5></h5>
					<img src="./woman/WPants/프런트 크로스 매니시 팬츠_WF18/WF18_5.png" width="100%">
					<h5></h5>
			...
			<div class="col-md-4" align="center">
				<div style="position: fixed; left: 68%; transform: translate(-32%, 0);">
					<div style="margin-top: 20px"><h4>프런트 크로스 매니시 팬츠</h4></div>
					...
					<p>INFO</p>
					앞면 턱 디테일 하이웨이스트 와이드 레그 팬츠. 
					앞면 포켓과 파이핑 처리된 뒷면 페이크 포켓. 
					지퍼, 내부 버튼, 메탈 후크 여밈.
					</div>
