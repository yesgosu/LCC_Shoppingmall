		...
		<div class="row">
			<div class="col-md-8">
				<div class="row" style="margin: 20px;" align="center">
					<img src="./man/Denim/슬림핏 진_MG16/MG16_2.png"width="100%">
					<h5></h5>
					<img src="./man/Denim/슬림핏 진_MG16/MG16_3.png"width="100%">
					<h5></h5>
					<img src="./man/Denim/슬림핏 진_MG16/MG16_4.png"width="100%">
					<h5></h5>
					<img src="./man/Denim/슬림핏 진_MG16/MG16_5.png"width="100%">
					<h5></h5>
					<img src="./man/Denim/슬림핏 진_MG16/MG16_6.png"width="100%">
					<h5></h5>
					<img src="./man/Denim/슬림핏 진_MG16/MG16_7.png"width="100%">
					<h5></h5>
			...
			<div class="col-md-4" align="center">
				<div style="position: fixed; left: 68%; transform: translate(-32%, 0);">
					<div style="margin-top: 20px"><h4>슬림핏 진</h4></div>
