		...
		<div class="row">
			<div class="col-md-8">
				<div class="row" style="margin: 20px;" align="center">
					<img src="./man/Shirt/체크 스트럭처 셔츠_MD14/MD14_1.png" width="100%">
					<h5></h5>
					<img src="./man/Shirt/체크 스트럭처 셔츠_MD14/MD14_2.png" width="100%">
					<h5></h5>
					<img src="./man/Shirt/체크 스트럭처 셔츠_MD14/MD14_3.png" width="100%">
					<h5></h5>
					<img src="./man/Shirt/체크 스트럭처 셔츠_MD14/MD14_4.png" width="100%">
					<h5></h5>
					<img src="./man/Shirt/체크 스트럭처 셔츠_MD14/MD14_5.png" width="100%">
					<h5></h5>
					<img src="./man/Shirt/체크 스트럭처 셔츠_MD14/MD14_6.png" width="100%">
					<h5></h5>
			...
			<div class="col-md-4" align="center">
				<div style="position: fixed; left: 68%; transform: translate(-32%, 0);">
					<div style="margin-top: 20px"><h4>체크 스트럭처 셔츠</h4></div>
					...
					<p>INFO</p>
					버튼이 달린 커프스 마감 긴소매 라펠 칼라 릴렉스핏 셔츠. 
					가슴 부분 플랩 패치 포켓. 
					앞면 버튼 여밈.
					</div>
